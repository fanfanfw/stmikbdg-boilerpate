...
export const arsipApi = {
    ...
    previewVerified: (id) => getBlob(`/admin/institutional-archives/${id}/preview-verified`),
    downloadVerified: (archive) => downloadBlob(`/admin/institutional-archives/${archive.institutional_archive_id}/download`, archive.current_file?.display_filename || `arsip-${archive.institutional_archive_id}`),
    downloadMaster: (archive) => downloadBlob(`/admin/institutional-archives/${archive.institutional_archive_id}/download-master`, archive.current_file?.display_filename || `arsip-${archive.institutional_archive_id}`),
    retryVerification: (id) => postJson(`/admin/institutional-archives/${id}/verification/retry`),
