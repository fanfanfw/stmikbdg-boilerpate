...
import AdminInstitutionalStorage from "./admin/AdminInstitutionalStorage";
    ...
    if (isAdmin) {
        return (
            <Routes>
                ...
                <Route path="/home/arsip-lembaga/storage" element={<AdminInstitutionalStorage />} />
                ...
                <Route path="/home/dokumen-akademik" element={<AdminAcademicDocuments />} />
