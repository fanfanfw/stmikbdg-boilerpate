...
JS;
        ...
        foreach (['TargetPicker', 'window.confirm', 'fetchTargets:', 'expected_updated_at', 'current_page', 'last_page', 'distributionPanelController', 'currentArchiveId', 'Lihat target', 'Edit draft', 'Batalkan draft', 'Lihat penerima', 'capture(`edit:${id}`)', "capture('viewer')", 'Tambah/hapus target', 'Preview target draft', 'Kriteria segment aktif', 'target_segment_ids', "status === 'published' && active", 'refresh(capture, page)'] as $contract) {
