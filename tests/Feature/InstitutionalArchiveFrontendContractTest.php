...
JS;
    ...
    public function test_phase_six_distribution_helpers_and_wiring_execute(): void
    {
        ...
        $script = <<<'JS'
import assert from 'node:assert/strict';
const { distributionActionPolicy, distributionExpiry, distributionListRequest, distributionPanelController, distributionPayload, distributionPreviewConfirmed, distributionRecipientStatus, distributionTargetFingerprint, exactDistributionSource, fetchDistributionPanelData, loadControlledPage, recipientPageRequest, recipientPreviewEndpoint, recipientStatus, requestSequence, recipientStatusView, routeLifecycle, runAuthoritativePublish, runControlledPageRefresh, runRecipientAction, userDistributionController } = await import(process.argv[1]);
